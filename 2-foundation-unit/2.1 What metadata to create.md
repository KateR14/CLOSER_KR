...
## Finding the right metadata schema

_Tools to find the right metadata schemas_
_How to choose the right metadata schema_

---

## Exercise

_Find a metadata schema relevant for a worked example // your own research_
...
## How to find the right metadata standard 
