...
Both contain the same information. However, if I was researcher conducting a review of existing different datasets , which format would be more useful to me.
...
## Defining metadata
  ...
  - By being structured and machine-readable metadata:
    - Standardises the content and structure of documentation make it easier for computers to extract information from the metadata
    - Tells a computer what something is, how it relates to other things (“objects”), and what to do with it
    - Makes data management easier and more efficient
    - Can be used researchers to help them discover, understand and access data
...
Watch [this knowledge clip from UGent University](https://www.youtube.com/watch?v=DW2T_cnqKPU) to gain an overview of what metadata is in research.
...
Thinking back to FAIR data principles, consider how metadata helps each principles
