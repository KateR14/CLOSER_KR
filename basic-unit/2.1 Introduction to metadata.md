...
Imagine the liquid inside the can is a dataset. The information about the drink: the brand, the country of production, the ingredient list, the nutrition and the best before date is the metadata which tells us what the dataset is. Like the plain can, without any metadata, we cannot know what the dataset consists of or the contextual information like who conducted the research and when.
