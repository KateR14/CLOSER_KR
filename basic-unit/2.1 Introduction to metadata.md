...
As the can shows us, metadata is not exclusive to the research/data context. In fact, it is everywhere and we use it all the time.

For example, can you spot the metadata in these screenshots:
...
## We have probably already come across metadata in a research context already

Can you identify the metadata in this article pages ...

![](img/easlt-cs-sh.png "Alt text here") ![](img/lmlc-cs-sh.png "Alt text here")
...
- Building on the definition we looked at before, metadata in a research context is ...
  - Machine-readable, unlike textual metadata like a PDF or journal article or a codebook
    - Metadata standardises the content and structure to make it easier for computers to extract information from the metadata
    - Metadata must be structured according to a specific set of rules
