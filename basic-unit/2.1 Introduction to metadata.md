...
Without this data, we wouldn't be able to understand the dataset. This means other researcher

Capturing this metadata means the data is more discoverable, available for re-use, and it also makes it machine-actionable to make data management easier and more efficient, and the data more discoverable. 
