...
The information about the drink (the brand, the country of production, the ingredient list, the nutrition and the best before date) is the metadata which tells us what the dataset is. 
...
If I was researcher trying to search for datasets, what would be more helpful for me:
...
## What is metadata 
  ...
  - Importantly, metadata is machine-readable, unlike textual metadata like a PDF or journal article or a codebook
...
## What information is needed to understand and use this data

If I was given this dataset, would I be able to use it?
...
What would I need to know in order to use this dataset?
