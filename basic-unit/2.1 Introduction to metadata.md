...
- also include study level information ]
...
Metadata provides information enabling us to make sense of data (e.g. documents, images, datasets), concepts (e.g. controlled vocabularies, classification schemes), real-world entities (e.g. people, organisations, places) and processes (e.g. data collections, archiving, computation)
