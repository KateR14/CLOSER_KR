...
I AM ADDING NOTES TO A BRANCH

----

## Intended Learning Outcome
- Understand the DIFFERENCE IN THE CHANGES
...
Making changes to the base branch whilst sub-branch is live.
...
For example, data in the weather app was represented as:
  - Numbers e.g. 16*
  - Text e.g. 'Sunny conditions will continue all day.'
  - Symbols e.g. ☀️
---
