...
- Data could be less secure
  - There is no clear data usage or sharing policies so data could be misused
  - Data are not stored in secure locations could be lost or accessed by people without permission
    
- Time wasted trying to understand data or organise data retrospectively
  - Researchers have to spend longer trying to understand what the data is conveying
